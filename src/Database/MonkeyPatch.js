...
const _from = mquery.prototype.from
 ...
 * @chainable
 */
mquery.prototype.from = function (name) {
 ...
 * @for Database
 */
mquery.prototype.table = function (...args) {
 ...
 * @for Database
 */
mquery.prototype.into = function (...args) {
  return this.from(...args)
}
 ...
 * @chainable
 */
mquery.prototype.withOutPrefix = function () {
 ...
 * @chainable
 */
mquery.prototype.forPage = function (page = 1, perPage = 20) {
 ...
 */
mquery.prototype.paginate = async function (page = 2, perPage = 20) {
